    ...
    <form id="form_2" action="" method=" post">
        <table class="table install-table table-border fs-4 align-middle">
            <tr>
                ...
                <td class="col-6 text-center p-0 ">
                    <input type="text" class="form-control fs-4 h-info_form border-bl text-center" id="network_ip" name="network_ip">
                </td>
            </tr>
            <tr>
                <td></td>
                ...
                <td class="col-6 text-center p-0 ">
                    <input type="text" class="form-control fs-4 h-info_form border-bl text-center" id="network_subnet" name="network_subnet">
                </td>
            </tr>
            <tr>
                <td></td>
                ...
                <td class="col-6 text-center p-0 ">
                    <input type="text" class="form-control fs-4 h-info_form border-bl text-center" id="network_gateway" name="network_gateway">
                </td>
            </tr>
            <tr>
                <td></td>
                <td colspan="1">DNS</td>
                <td class="col-6 text-center p-0 ">
                    <input type="text" class="form-control fs-4 h-info_form border-bl text-center" id="network_dns" name="network_dns">
                </td>
            </tr>
        </table>
        ...
        <table class="table install-table table-border fs-4 align-middle">
            <tr>
                ...
                <td class="col-2">IP</td>
                <td class="col-6 text-center p-0 ">
                    <input type="text" class="form-control fs-4 h-info_form border-bl text-center" id="server_ip" name="server_ip">
                </td>
            </tr>
            <tr>
                <td></td>
                ...
                <td class="col-6 text-center p-0 ">
                    <input type="text" class="form-control fs-4 h-info_form border-bl text-center" id="server_port" name="server_port">
                </td>
            </tr>
            <tr>
                <td></td>
                <td colspan="1">ID</td>
                <td class="col-6 text-center p-0 ">
                    <input type="text" class="form-control fs-4 h-info_form border-bl text-center" id="server_id" name="server_id">
                </td>
            </tr>
            <tr>
                <td></td>
                ...
                <td class="col-6 text-center p-0 ">
                    <input type="text" class="form-control fs-4 h-info_form border-bl text-center" id="server_pwd" name="server_pwd">
                </td>
            </tr>
        </table>
        <div class="border-bottom-bl"></div>
        ...
        <table class="table table-border install-table align-middle mt-4 fs-4">
            ...
            <tr>
                ...
                <td class="col text-center p-0">
                    <input type="text" class="col form-control fs-4 h-info_form border-bl text-center" id="distance1" name="distance1">
                </td>
            ...
            <tr>
                ...
                <td class="col text-center p-0">
                    <input type="text" class="col form-control fs-4 h-info_form border-bl text-center" id="distance2" name="distance2">
                </td>
                <td class="col text-center p-0">
                    km
                </td>
            ...
            <tr>
                ...
                <td class="col text-center p-0">
                    <input type="text" class="col form-control fs-4 h-info_form border-bl text-center" id="distance3" name="distance3">
                </td>
                <td class="col text-center p-0">
                    km
                </td>
            ...
            <tr>
                ...
                <td class="col text-center p-0">
                    <input type="text" class="col form-control fs-4 h-info_form border-bl text-center" id="distance4" name="distance4">
                </td>
        ...
        <div class="text-end mt-3">
            <button type="button" class="btn btn-outline-primary btn-mobile col-4" onclick="top_menu(4)">수정</button>
        </div>
    </form>
</div>