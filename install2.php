  ...
  <body>
    ...
    <div class="container container-mobile-1 pb-3">
        ...
        <table class="table table-striped table-scroll">
            ...
            <tbody>
                <tr>
                    <td class=""><input class="form-check-input" type="checkbox" value="" id="flexCheckDefault"></td>
                    <td onclick="location.replace('/install-info.php') ">6</td>
                    <td onclick="location.replace('/install-info.php') ">MMM2204K17</td>
                    <td onclick="location.replace('/install-info.php') ">아이초등학교</td>
                    <td onclick="location.replace('/install-info.php') ">2022.02.06</td>
                    <td class="text-center">99/99</td>
                </tr>
                <tr>
                    <td class=""><input class="form-check-input" type="checkbox" value="" id="flexCheckDefault"></td>
                    <td onclick="location.replace('/install-info.php') ">6</td>
                    <td onclick="location.replace('/install-info.php') ">00701</td>
                    <td onclick="location.replace('/install-info.php') ">아이초등학교가가가가가</td>
                    <td onclick="location.replace('/install-info.php') ">2022.02.06</td>
        ...
        <div class="mt-5 ">
            <button type="button" class="btn btn-secondary border rounded-3 col-3 fs-5 h-6r"> 장소별<br>다운로드 </button>
            <button type="button" class="btn btn-secondary border rounded-3 col-3 fs-5 mx-4 h-6r"> 총 설치내역<br>다운로드</button>
