<div class="mt-2 mb-3">
  <header class="row d-flex flex-wrap align-items-center pb-2 nav_bottom_line row">
    <div class="col-10 text-dark text-decoration-none flex-item">
      <img class="header_img mx-2" src=" ./image/iconnect_main.png" alt="" onclick="location.href = '/' ">
      <span class="fs-mobile-4 p-0 mx-3" onclick="location.href = '/install.php' ">설치</span>
